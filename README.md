...
Sou estudante de **Análise e Desenvolvimento de Sistemas** com foco total no ecossistema **Front-end**. Atualmente, dedico meus estudos à consolidação de projetos modernos utilizando **Vue.js** e **Tailwind CSS**.

- 💡 **Transição de Carreira:** Venho de uma experiência sólida como Analista de Suporte, o que me deu uma base forte em resolução de problemas, criação de chatbots e análise de dados.
- 🌱 **Evolução:** Busco minha primeira oportunidade como Desenvolvedor Júnior ou Estagiário para aplicar meu conhecimento técnico e colaborar com times ágeis.
- 🎯 **Foco atual:** Aperfeiçoamento em arquitetura de componentes e consumo de APIs REST.
